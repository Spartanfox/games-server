...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { game_id: @level.game_id, gamemode: @level.gamemode, image_url: @level.image_url, name: @level.name } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { game_id: @level.game_id, gamemode: @level.gamemode, image_url: @level.image_url, name: @level.name } }
